...
class _LoginParentState extends State<LoginParent> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthenticationBloc, AuthenticationState>(
      listener: (context, state) {
        ...
        if (state is AuthenticationAuthenticatedParent) {
          Navigator.pushNamedAndRemoveUntil(context, studentListRoute, (route) => false);
        }
      },
      child: Scaffold(
        body: BlocProvider(
                                  ...
                                  child: Form(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        _buildLoginParentBtn(context, state)
                                      ],
                                    ),
                                  ),
                                ),
  ...
  Widget _buildLoginParentBtn(context, state) {
    return Container(
